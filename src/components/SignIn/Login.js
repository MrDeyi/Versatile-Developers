...
function Login(){
 ...
 // }*/
  ...
  return(
    <section className='v-100' style={{backgroundColor: "lightblue"}} data-testid ="login" >
      <div className="container-fluid h-custom">
        <div className="row d-flex justify-content-center align-items-center h-100">
            ...
            <div className="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
              ...
              <form  className="Loginfrom" name='form' id = "form">

                <div className="d-flex flex-row align-items-center justify-content-center justify-content-lg-start">
                  <p className='lead fw-normal mb-0 me-3'>Sign in with</p>

                  <button className="btn btn-primary btn-floating mx-1" data-testid="btn1">
                    <i className="fab fa-facebook-f"></i>
                  </button>

                  <button className='btn btn-primary btn-floating mx-1' data-testid="btn2">
                    <i className='fab fa-linkedin-in'></i>
                  </button>

                  <button  className="btn btn-primary btn-floating mx-1" data-testid="btn3">
      ...
      <div
        ...
        <div class="text-white mb-3 mb-md-0" data-testid="footer">
          Copyright © 2022. All rights reserved.
        </div>

        <div>
          <a href="#!" class="text-white me-4" data-testid="facebook">
            <i class="fab fa-facebook-f"></i>
          </a>
          <a href="#!" class="text-white me-4" data-testid="twitter">
            <i class="fab fa-twitter"></i>
          </a>
          <a href="#!" class="text-white me-4" data-testid="google">

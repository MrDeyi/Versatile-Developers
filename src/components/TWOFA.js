...
function TWOFA() {
  ...
  return (
    <div className={TWO.box}>
      ...
      <h1 className={TWO.h1}>for your security, we want to make sure it's really you,We have sent 6 code to your email:{currentUser.email}</h1>
      <input
        className={TWO.input} 
        type ="text"
      ...
      <button className='button' onClick={Confirm}>Confirm PIN</button>
    </div>
  ); 
};
